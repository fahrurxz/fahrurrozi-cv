...
export default function Hero() {
  const words = [
    ...
    "Python Automation & API Integration Specialist",
...
const profile = {
    ...
    skills: [
        ...
        'API Integration', 'Web Scraping', 'UI/UX Design',
        'Docker', 'Git', 'SQL', 'Cyber Security',
    ...
    email: 'fahrurrozi3313@gmail.com',
    hireable: function() {
        return (
            this.hardWorker &&
            this.problemSolver &&
            ...
            <div className="w-full lg:w-1/2 mb-12 lg:mb-0 animate__animated animate__fadeInLeft relative">
              ...
              <div className="relative mb-8 sm:mb-12 max-w-xl">
                <p className="text-base sm:text-xl text-gray-300/90 leading-relaxed">
                  Python automation specialist  | Full-Stack Developer | Crafting efficient solutions
              ...
              <div className="flex flex-col sm:flex-row gap-4 sm:gap-6 animate__animated animate__fadeInUp animate__delay-2s">
                ...
                <a
                  href="https://www.linkedin.com/in/fahrurrozi03/"
                  target="_blank"
                ...
                {/* Contact Button */}
                <a
                  href="/FahrurRozi_CV.pdf"
                  download="Fahrur_Rozi_CV.pdf"
